        ...
        <>
            <style>{`
                ...
                @media (max-width: 960px) {
                    .signup-left  { padding: 2rem; flex: 0.65; }
                    .signup-right { width: 460px; padding: 2rem 1.75rem; }
                }
                /* Mobile: hide left, form full-width */
            ...
            <div style={{ minHeight: '100vh', display: 'flex', fontFamily: 'DM Sans, sans-serif', background: '#f9fafb' }}>
                ...
                <div className="signup-right">
                    <div style={{ width:'100%', maxWidth:'400px', animation:'fadeInUp .6s ease both' }}>
                        ...
                        <div style={{ marginBottom:'2rem' }}>
                            ...
                            <p style={{ color:'#6b7280', fontSize:'14px', margin:0 }}>
                                ...
                                <span onClick={() => navigate('/signin')} style={{ color:'#ff4d2d', fontWeight:'600', cursor:'pointer' }}>Sign In</span>
                            </p>
                        </div>
                        ...
                        {/* Full Name + Email side by side on wider screens, stacked on mobile */}
                        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'12px', marginBottom:'14px' }} className="signup-name-email">
                            <div>
                        ...
                        <button onClick={handleSignUp} disabled={loading} style={{
                            ...
                            onMouseEnter={e => { if (!loading) { e.currentTarget.style.transform='translateY(-2px)'; e.currentTarget.style.boxShadow='0 12px 32px rgba(255,77,45,0.4)' } }}
                        ...
                        {/* Mobile back link */}
                        <p style={{ textAlign:'center', marginTop:'2rem', fontSize:'13px', color:'#9ca3af' }}>
            ...
            <style>{`
                /* Stack name+mobile fields on small screens */
