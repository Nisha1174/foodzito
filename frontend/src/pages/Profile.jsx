    ...
    return (
        <>
            ...
            <div style={{ minHeight: '100vh', background: '#f9fafb', fontFamily: 'DM Sans, sans-serif' }}>
                ...
                <div style={{ maxWidth: '700px', margin: '0 auto', padding: 'clamp(1rem,3vw,2rem) clamp(1rem,3vw,1.5rem)' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ padding: '0 clamp(1rem,3vw,2rem) clamp(1.2rem,3vw,2rem)' }}>
                            {/* Avatar */}
                            <div style={{
                                ...
                                marginTop: '-36px', marginBottom: '14px',
                            ...
                            <div className="profile-header-row" style={{
                                ...
                                <div style={{ minWidth: 0 }}>
                                    ...
                                    <p style={{
                                        margin: '0 0 10px', color: '#6b7280', fontSize: '14px',
                                        overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap'
                                    }}>{userData?.email}</p>
                                    <span style={{
                    ...
                    <div style={{
                        ...
                        {!editing ? (
                            <div className="profile-info-grid">
                                {[
                                    ...
                                    <div key={i} style={{
                                        ...
                                        <p style={{
                                            margin: 0, fontSize: '14px', color: '#111', fontWeight: '600',
                                            overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap'
                                        }}>{item.value}</p>
                                    </div>
                                ))}
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                ...
                                <div style={{ background: '#f9fafb', borderRadius: '12px', padding: '12px 16px', border: '1px solid #f3f4f6' }}>
                    ...
                    <div style={{
                        ...
                        <h3 style={{ fontFamily: 'Syne, sans-serif', fontSize: '1rem', fontWeight: '700', color: '#0f0f0f', margin: '0 0 16px' }}>
                            Quick Links
                        </h3>
