        ...
        <>
            <style>{`
                ...
                @media (max-width: 900px) {
                    .signin-left  { padding: 2rem; flex: 0.7; }
                    .signin-right { width: 420px; padding: 2.5rem 2rem; }
                }
                /* Mobile: hide left panel, form goes full width */
                    ...
                    <div style={{ width: '100%', maxWidth: '380px', animation: 'fadeInUp .6s ease both' }}>
                        ...
                        <div style={{ marginBottom: '2.5rem' }}>
                            ...
                            <p style={{ color: '#6b7280', fontSize: '14px', margin: 0 }}>
                                ...
                                <span onClick={() => navigate('/signup')} style={{ color: '#ff4d2d', fontWeight: '600', cursor: 'pointer' }}>
                                    Sign Up
                                </span>
                            </p>
                        </div>
                        ...
                        <div style={{ textAlign: 'right', marginBottom: '24px' }}>
                            <span
                                ...
                                style={{ fontSize: '13px', color: '#ff4d2d', fontWeight: '600', cursor: 'pointer' }}
